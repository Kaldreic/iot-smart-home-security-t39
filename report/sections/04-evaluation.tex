...
\addlinespace
Resilience at scale          & \textsc{AirBugCatcher}                & 0.266 & 0.632 & 0.52 & 41\\
{\footnotesize 15,000 bugs, 75,000 campaigns} & \textsc{AirBugCatcher} $+$ 1 confirmation & 0.359 & 0.090 & 0.92 & 342\\
                             & RDD                                   & \textbf{0.824} & \textbf{0.000} & \textbf{0.21} & 143\\
\bottomrule
\end{tabular*}
\end{table*}
...
genuine / false credit; reads for the last row are given in the text.}
\label{tab:noise}
\centering
\footnotesize
...
a miss rate calibrated to a flaky-test rerun corpus~\cite{flakeflagger2021} and
phantom rates we chose,
...
one fifth of RDD's reads. The confirmation control shows that one confirming
